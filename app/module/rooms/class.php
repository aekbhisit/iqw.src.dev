...
///////////////////////////////////////////////////////////////////////////////////
	...
	function insertData($category_id,$name,$slug,$concept,$description,$content,$image,$gallery,$facility,$price,$discount,$currency,$params,$meta_key,$meta_description,$user_id,$status){
	...
	function updateData($id,$category_id,$name,$slug,$concept,$description,$content,$image,$gallery,$facility,$price,$discount,$currency,$params,$meta_key,$meta_description,$user_id,$status){
...
// page translate
  ...
  function saveTranslate( $lang,$id,$name,$content,$content1,$content2,$params,$meta_key,$meta_description){
