...
if(isset($_GET['task'])){
	...
	switch($task){
		case 'getCategoriesData':
			...
			$iconbar .=	'<a href="#"><img src="images/icons/color/pencil.png" /></a><a href="#"><img src="images/icons/color/cross.png" /></a>';
			for($i=0;$i<10;$i++){
				$order = '<a href="#"><img src="images/icons/black/16/arrow_up_small.png" /></a><a href="#"><img src="images/icons/black/16/arrow_down_small.png" /></a>';
