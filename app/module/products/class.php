...
class Products extends Database {
	...
	public function insertData($category_id,$name,$slug,$content,$image,$image1,$image2,$image3,$image4,$params,$meta_key,$meta_description,$user_id,$status){
	...
	public function updateData($id,$category_id,$name,$slug,$content,$image,$image1,$image2,$image3,$image4,$params,$meta_key,$meta_description,$user_id,$status){
