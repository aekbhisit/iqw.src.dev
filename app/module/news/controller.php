...
$params_category = array(
	'module'=>'news_categories',
 	...
 	'primary_key'=>'id',
 	'parent_table'=> 'news',
	'parent_translate_table'=>'news_categories_translate',
	'parent_primary_key'=>'id',
	'translate_table'=>'news_translate',
	'site_language'=>SITE_LANGUAGE,
	'is_translate'=>SITE_TRANSLATE
);
$oCategories = new News($params_category);
$params = array(
	'module'=>'news',
 	'table'=>'news',
 	'primary_key'=>'id',
	'parent_table'=> 'news_categories',
	'parent_table_translate'=> 'news_categories_translate',
	'parent_primary_key'=> 'id',
	'translate_table'=>'news_translate',
	'site_language'=>SITE_LANGUAGE,
	'is_translate'=>SITE_TRANSLATE
	...
	switch($task){
		...
		case 'formInit':
			if($_GET['mode']=='edit'){
				...
				$data['content'] = $oModule->setString($data['content']);
