...
///////////////////////////////////////////////////////////////////////////////////
	...
	public function getTranslate($id,$lang){
		...
		//print_r($gallery['images_list']);
		return  $gallery;
	}
	
	function insertData($category_id,$name,$content,$slug,$cover,$params,$meta_key,$meta_description,$user_id,$status){
	...
	function updateData($id,$category_id,$name,$content,$slug,$cover,$params,$meta_key,$meta_description,$user_id,$status){
	...
	function insertDataImage($gallery_id,$image,$title,$description,$sequence){
	...
	function deleteDataImage($image_id){
	...
	function updateDataImage($gallery_id,$image_id,$image,$title,$description,$sequence){
	...
	function insertDataImageTranslate($lang,$image_id,$title,$description){
	...
	function updateDataImageTranslate($lang,$image_id,$title,$description){
		$this->sql ="update galleries_images_translate  set title='$title',description='$description' where image_id=$image_id and lang='$lang' ";
		$this->update();
	}
	
	function saveDataImageTranslate($lang, $image_id,$title,$description){
