...
///////////////////////////////////////////////////////////////////////////////////
	...
	function getOrderAll($isOrderDetail=true){
	...
	function getOrder($id,$isOrderDetail=true){
			$this->sql = "select * from $this->table where $this->table.$this->primary_key = $id ";
			$this->select();
			$order =  $this->rows[0] ;
			if($isOrderDetail){
	...
	function insertOrder($vat_rate,$vat_total,$ship_fee,$sub_total,$discount,$grand_total,$currency_id,$status){
	...
	function insertOrderDetail($order_id,$catalog_id,$quantity,$pirce,$discount,$discount_percentage,$total){
	...
	function insertOrderBuyer($order_id,$is_member,$member_id,$name,$address,$address1,$city,$state_id,$country_id,$zipcode,$email,$mobile,$tel,$fax){
	...
	function updateOrderBuyer($id,$order_id,$is_member,$member_id,$name,$address,$address1,$city,$state_id,$country_id,$zipcode,$email,$mobile,$tel,$fax){
	...
	function updateOrder($id, $vat_rate,$vat_total,$ship_fee,$sub_total,$discount,$grand_total,$currency_id,$status){
	...
	function updateOrderDetail($id, $order_id,$catalog_id,$quantity,$pirce,$discount,$discount_percentage,$total){
...
// frontend function 
	...
	public function getMycoupon($member_id){
		...
		$this->sql .= " left join currency on orders.currency_id=currency.id ";
		//$this->sql .= " where orders.status=1 ";
		$this->select() ;
		$orders =  $this->rows ;
		if(!empty($orders)){
	...
	function recalOrderTotal($order_id){
	...
	function minusOrderItems($order_id){
