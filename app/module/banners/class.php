...
class Banners extends Database {
	...
	public function insertData($category_id,$name,$slug,$content,$image,$params,$link,$meta_key,$meta_description,$user_id,$status,$start,$end){
	...
	public function updateData($id,$category_id,$name,$slug,$content,$image,$params,$link,$meta_key,$meta_description,$user_id,$status,$start,$end){
