...
class Members extends Database {
	...
	public function getLoginUser($user_login_id=NULL){
		...
		$this->sql = "select $this->table.*,$this->parent_table.name as role from $this->table,$this->parent_table where $this->table.$this->primary_key=$user_login_id and $this->table.category_id=$this->parent_table.$this->parent_primary_key ";
		$this->select();
