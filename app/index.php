...
/*
	...
	//loadmodule
	 if (isset($_GET['module'])){
		 $module = $_GET["module"] ;
		 if($module!='users'){
			include('module/users/class.php') ; 
		 }
		 if(is_file("module/".$module."/init.php")){
			include("module/".$module."/init.php") ;
			include('classes/helper.php') ;
		 }
		  if(is_file("module/".$module."/class.php")){
			include("module/".$module."/class.php") ; 
		 }
		 if(is_file("module/".$module."/controller.php")){
			include("module/".$module."/controller.php") ; 
		 }
	 }
}
