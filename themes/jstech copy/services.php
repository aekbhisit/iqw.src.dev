                        ...
                        <div class="box-container services-content">
                            <div class="col-md-6 wow fadeInUp" data-wow-delay="0">
                                <div class="box-with-icon-left">
                                    ...
                                    <div class="text">
                                        <img src="img/img_services05.jpg" alt="">
                                        <h2>High pressure water jet cleaning</h2>
                                        ...
                                        <a href="services-cate01.php" class="btn-text">View Details</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 wow fadeInUp" data-wow-delay="0">
                                <div class="box-with-icon-left">
                                    ...
                                    <div class="text">
                                        <img src="img/img_services01.jpg" alt="">
                                        <h2>Bolting service</h2>
                                        <p><b>Lorem Ipsum</b> is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                                        <div class="divider-single"></div>
                                        <a href="services-cate02.php" class="btn-text">View Details</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 wow fadeInUp" data-wow-delay="0">
                                <div class="box-with-icon-left">
                                    <i class="fa fa-cubes icon-big"></i>
                                    <div class="text">
                                        <img src="img/img_services02.jpg" alt="">
                                        <h2>Chemical cleaning</h2>
                                        <p><b>Lorem Ipsum</b> is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                                        <div class="divider-single"></div>
                                        <a href="services-cate03.php" class="btn-text">View Details</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 wow fadeInUp" data-wow-delay="0">
                                <div class="box-with-icon-left">
                                    <i class="fa fa-cube icon-big"></i>
                                    <div class="text">
                                        <img src="img/img_services03.jpg" alt="">
                                        <h2>Dry ice cleaning</h2>
                                        <p><b>Lorem Ipsum</b> is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                                        <div class="divider-single"></div>
                                        <a href="services-cate04.php" class="btn-text">View Details</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 wow fadeInUp" data-wow-delay="0">
                                <div class="box-with-icon-left">
                                    <i class="fa fa-cube icon-big"></i>
                                    <div class="text">
                                        <img src="img/img_services04.jpg" alt="">
                                        <h2>Fabrication</h2>
                                        <p><b>Lorem Ipsum</b> is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                                        <div class="divider-single"></div>
                                        <a href="services-cate05.php" class="btn-text">View Details</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 wow fadeInUp" data-wow-delay="0">
                                <div class="box-with-icon-left">
                                    <i class="fa fa-cubes icon-big"></i>
                                    <div class="text">
                                    	<img src="img/img_services06.jpg" alt="">
                                        <h2>Retube for Heat exchancer and condenser</h2>
                                        <p><b>Lorem Ipsum</b> is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                                        <div class="divider-single"></div>
                                        <a href="services-cate06.php" class="btn-text">View Details</a>
                                    </div>
                                </div>
                            </div>
