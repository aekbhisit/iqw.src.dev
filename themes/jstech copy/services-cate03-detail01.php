    ...
    <div id="content" class="no-padding">
        ...
        <section class="services-detail">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <img src="img/img_cate03_detail0101.jpg" alt="">
                        <img src="img/img_cate03_detail0102.jpg" alt="">
                        <img src="img/img_cate03_detail0103.jpg" alt="">
                        <img src="img/img_cate03_detail0104.jpg" alt="">
                    </div>
                    ...
                    <div class="col-md-6 wow fadeInRight" data-wow-delay=".5s" data-wow-duration=".8s">
                        ...
                        <h3>ให้บริการงานล้างด้วยเคมี</h3>

                        <p>
                            สำหรับงานท่อ อุปกรณ์แลกเปลี่ยนความร้อน เช่น Shell and tube heat exchanger, Pleat Exchanger ,Coil และ พื้นผิวทั่วไป
                        </p>
