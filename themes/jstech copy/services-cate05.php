                        ...
                        <div class="box-container services-content">
                            <div class="col-md-6 wow fadeInUp" data-wow-delay="0">
                                <div class="box-with-icon-left">
                                    ...
                                    <div class="text">
                                    	<img src="img/img_services_cate0501.jpg" alt="">
                                        <h2>Fabrication Pipe line</h2>
                                        ...
                                        <a href="services-cate05-detail01.php" class="btn-text">View Details</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 wow fadeInUp" data-wow-delay="0">
                                <div class="box-with-icon-left">
                                    <i class="fa fa-cube icon-big"></i>
                                    <div class="text">
                                        <img src="img/img_services_cate0502.jpg" alt="">
                                        <h2>Fabrication Structure</h2>
                                        <p><b>Lorem Ipsum</b> is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                                        <div class="divider-single"></div>
                                        <a href="services-cate05-detail02.php" class="btn-text">View Details</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 wow fadeInUp" data-wow-delay="0">
                                <div class="box-with-icon-left">
                                    <i class="fa fa-cube icon-big"></i>
                                    <div class="text">
                                        <img src="img/img_services_cate0503.jpg" alt="">
                                        <h2>Fabrication Tank</h2>
                                        <p><b>Lorem Ipsum</b> is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                                        <div class="divider-single"></div>
                                        <a href="services-cate05-detail03.php" class="btn-text">View Details</a>
                                    </div>
                                </div>
                            </div>
