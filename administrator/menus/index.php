...
<body>
        ...
        <div id="da-sidebar-separator"></div>
          ...
          <div id="da-content-wrap" class="clearfix">
            ...
            <div id="da-content-area">
              <div style="display:block; width:100%; min-height:35px; height:auto; clear:both; padding-left:10px; padding-right:10px;"><a href="categories-form.php?mode=add"><button class="da-button green medium">เพิ่มกลุ่มเมนูใหม่</button></a></div>
                <div class="grid_4">
    ...
    <div id="da-footer">
      <div class="da-container clearfix">
        <p>Copyright 2<?=date('Y')?>. <?=ucfirst($_SERVER['SERVER_NAME'])?> All Rights Reserved.
      </div>
    </div>
  </div>
</body>
