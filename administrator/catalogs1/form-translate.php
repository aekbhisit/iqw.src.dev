                                ...
                                <div id="form-error" class="da-message error" style="display:none;"></div>
                                    	<div class="da-form-inline">
                                          ...
                                          <div class="da-form-row">
                                             ...
                                             <div class="da-form-row">
                                                <label>Product Structure<span class="required">*</span></label>
                                                <div class="da-form-item large">
                                                	<span class="formNote"  >ใส่ายละเอียด Product Structure</span>
                                                   <textarea id="content1" name="content1" class="elrte" style="overflow-x: hidden; overflow-y: hidden; height:500px; "></textarea>
                                                </div>
                                            </div>
                                            <div class="da-form-row">
                                                <label>Product Characteristics<span class="required">*</span></label>
                                                <div class="da-form-item large">
                                                	<span class="formNote"  >ใส่ายละเอียด Product Characteristics</span>
                                                   <textarea id="content2" name="content2" class="elrte" style="overflow-x: hidden; overflow-y: hidden; height:500px; "></textarea>
                                                </div>
                                            </div>
