...
<script type="text/javascript" src="attr-script.js"></script>
        ...
        <div id="da-content">
            ...
            <div class="da-container clearfix">
                ...
                <div id="da-content-wrap" class="clearfix">
                    ...
                    <div style="display:block; width:100%; min-height:35px; height:auto; clear:both; padding-left:10px; padding-right:10px;"><a href="attr-form.php?mode=add"><button class="da-button green medium">เพิ่มรายการใหม่</button></a></div>
