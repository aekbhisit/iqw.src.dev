        ...
        <div class="da-container clearfix">
          ...
          <?php 
					$breadcrumbs = array(
						...
						2=>array('name'=>'Block','alt'=>'Block','link'=>'javascript:void(0)','class'=>'active')
					);
          ...
          <div id="da-content-area">
              ...
              <div class="da-panel collapsible">
                <div class="da-panel-header">
                  <span class="da-panel-title">
                    <img src="../images/icons/black/16/list.png" alt="" />จัดการคอนเทน
                  </span>
                </div>
            ...
            <div style="display:block; width:100%; min-height:35px; height:auto; clear:both; padding-left:10px; padding-right:10px;">
              <button class="da-button blue medium" onclick="setCheckAll();">
                <label for="checkboxAll"><input name="checkboxAll" id="checkboxAll" type="checkbox" value="" />เลือกทั้งหมด</label>
              </button>
               | 
