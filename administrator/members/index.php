                ...
                <div class="da-container clearfix">
                  <!--search box-->
					...
					$breadcrumbs = array(
						...
						2=>array('name'=>'จัดการสมาชิก','alt'=>'Catalogs','link'=>'index.php','class'=>'active')
					);
        ...
        <div id="da-content">
            ...
            <div class="da-container clearfix">
                ...
                <div id="da-content-wrap" class="clearfix">
                    ...
                    <div style="display:block; width:100%; min-height:35px; height:auto; clear:both; padding-left:10px; padding-right:10px;"><a href="form.php?mode=add"><button class="da-button green medium">เพิ่มสมาชิกใหม่</button></a></div>
