        ...
        <div class="da-container clearfix">
          ...
          <?php 
					$breadcrumbs = array(
						...
						2=>array('name'=>'แบนเนอร์','alt'=>'Banners','link'=>'javascript:void(0)','class'=>'active')
					);
        ...
        <div id="da-content-wrap" class="clearfix">
          ...
          <div id="da-content-area">
            <div style="display:block; width:100%; min-height:35px; height:auto; clear:both; padding-left:10px; padding-right:10px;">
              <a href="form.php?mode=add"><button class="da-button green medium">เพิ่มรายการใหม่</button></a>
            </div>
            <div class="grid_4">
            ...
            <div style="display:block; width:100%; min-height:35px; height:auto; clear:both; padding-left:10px; padding-right:10px;">
              ...
              <button class="da-button pink medium" onclick="setReorderAll();" style="float:right; margin-right:20px;">เรียงลำดับข้อมูลใหม่ </button>
            </div>                       
