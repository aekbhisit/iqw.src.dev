                            	...
                            	<div class="da-panel">
                                    ...
                                    <div class="da-panel-content">
                                        ...
                                        <div class="da-form-inline">
                                            ...
                                            <div class="da-form-row">
                                                <label>ชื่อภาพ <span class="required">*</span></label>
                                                <div class="da-form-item large">
                                                	<span class="formNote">ใส่ชื่อภาพ</span>
                                            ...
                                            <div class="da-form-row">
                                                <label>URL </label>
                                                <div class="da-form-item large">
                                                    <span class="formNote">URL (ถ้ามี)</span>
                                            ...
                                            <div class="da-form-row">
                                                ...
                                                <div class="da-form-item large">
                                                    ...
                                                    <textarea id="content" name="content" class="texteditor" style="overflow-x: hidden; overflow-y: hidden; height:300px;"></textarea>
                                                </div>
                                                <div id="myelfinder"></div>
                                            </div>
                                          	 <div class="da-form-row" style="display:none">
                                                <label>ตั้งเวลาเปิด-ปิด</label>
                                            ...
                                            <div class="da-form-row">
                                                ...
                                                <div class="da-form-item small">
                                                    <span class="formNote">เลือกสถานการเปิดปิดการใช้งาน</span>
