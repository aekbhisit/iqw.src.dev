	...
	$(values).each(function(i,v){
				$('#defaultFieldTR0').remove();
				 ...
				 var list  = ' <tr id="defaultFieldTR'+v.id+'" style="height:35px;" ><input name="defaultFieldIsInsert['+v.id+']"  id="defaultFieldIsInsert['+v.id+']" type="hidden" value="0" />';
						   list  +='<td width="5%"><input name="defaultFieldSequence['+v.id+']" id="defaultFieldSequence['+v.id+']" type="text" style="width:95%" placeholder="0" value="'+v.sequence+'" /></td>';
						 ...
						 if(parseInt(v.selected)==1){
							 list  +='<td width="15%"><label><input name="defaultFieldChecked['+v.id+']" id="defaultFieldChecked['+v.id+']" type="checkbox" value="1" checked="checked" />Checked/Selected</label></td>';
						 }else{
							  list  +='<td width="15%"><label><input name="defaultFieldChecked['+v.id+']" id="defaultFieldChecked['+v.id+']" type="checkbox" value="1" />Checked/Selected</label></td>';
						 }
...
function addFieldValueList(){
	var numItem = $('#fieldValNumber').val();
	 var list  = ' <tr id="defaultFieldTR'+numItem+'" style="height:35px;" ><input name="defaultFieldIsInsert['+numItem+']"  id="defaultFieldIsInsert['+numItem+']" type="hidden" value="1" />';
			 list  +='<td width="5%"><input name="defaultFieldSequence['+numItem+']" id="defaultFieldSequence['+numItem+']" type="text" style="width:95%" placeholder="Value" value="'+(parseInt(numItem)+1)+'" /></td>';
			 ...
			 list  +='<td width="15%"><label><input name="defaultFieldChecked['+numItem+']" id="defaultFieldChecked['+numItem+']" type="checkbox" value="1" />Checked/Selected</label></td>';
