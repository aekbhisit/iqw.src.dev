...
<!--Text editor -->
<script type="text/javascript" src="../plugins/elrte/js/elrte.min.catalog.js"></script>
...
<!--google maps-->
<script src="http://maps.googleapis.com/maps/api/js?language=th&sensor=false&region=TH"></script>
                                ...
                                <div id="form-error" class="da-message error" style="display:none;"></div>
                                    	<div class="da-form-inline">
                                            ...
                                            <div class="da-form-row">
                                                ...
                                                <div class="da-form-item large">
                                                	<span class="formNote" >ใส่ชื่อ</span>
                                                    <input type="text" name="name" id="name" value="" />
                                                </div>
                                            </div>
                                            <div class="da-form-row" id="rowCatalogsSlug">
                                                <label>Slug </label>
                                                <div class="da-form-item large">
                                                	<span class="formNote" >ชื่อที่จะแสดงใน URL ต้องไม่ซ้ำกัน (ไม่ต้องใส่หากให้ระบบสร้างให้เอง)</span>
                                                    <input type="text" name="slug" id="slug" value="" />
                                                </div>
                                            </div>
                                      		<div class="da-form-row">
                                                <label>สถานะเปิด / ปิด<span class="required">*</span></label>
                                                <div class="da-form-item small">
                                                	<span class="formNote">เลือกสถานะเปิด / ปิด</span>
