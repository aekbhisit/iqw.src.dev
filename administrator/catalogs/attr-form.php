                                                    ...
                                                    <div style="display:block; width:100%; height:auto; padding-top:5px;">
                                                        ...
                                                        <tbody id="fieldListContainer">
                                                            <tr id="defaultFieldTR0" style="height:35px;"  ><input name="defaultFieldIsInsert[0]"  id="defaultFieldIsInsert[0]" type="hidden" value="0" />
                                                           		 <td width="5%"><input name="defaultFieldSequence[0]" id="defaultFieldSequence[0]" type="text" style="width:95%" placeholder="Value" value="1" /></td>
                                                                ...
                                                                <td width="15%"><label><input name="defaultFieldChecked[0]" id="defaultFieldChecked[0]" type="checkbox" value="1" />Checked/Selected</label></td>
