...
function setSaveTranslate(){
	var d = new Date();	
	var url = "../../app/index.php?module="+modules+"&task=saveTranslateData&d"+d.getTime() ;
...
function loadFormAttr(){
	var d = new Date();
	var id =  $('#id').val();
	var category_id = $('#category_id').val();
	var language = $('#translate_language').val();
	if(category_id==0){
		var url = "../../app/index.php?module="+modules+"&task=getAttrFieldTranslate&category_id="+category_id+"&language="+language+"&id="+id+"&d"+d.getTime() ;
		$.get(url,function(data){
			// console.log(data) ;
			$('#row_product_name').after(data);
			attrTextEditor();
