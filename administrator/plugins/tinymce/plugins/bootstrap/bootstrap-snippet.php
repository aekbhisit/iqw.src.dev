...
if ($allowEdit == 'true') { ?>
            <div class="row margin-bottom-md" id="new-snippet-form-wrapper">
                ...
                <div class="form-horizontal col-sm-8 col-sm-offset-2">
                    ...
                    <form name="new-snippet-form" id="new-snippet-form" action="">
...
<script type="text/javascript" src="js/htmlcleanmin.js"></script>
...
if ($allowEdit == 'true') { ?>
    ...
    $('#edit-snippet-button').on('click', function () {
        ...
        if ($(this).hasClass('btn-primary')) {
            ...
            $('#code-wrapper').html('<form name="edit-snippet-form" action=""><div class="form-group"> <label class="col-sm-4 col-xs-6 text-right">Title :</label> <div class="col-sm-8 col-xs-6"> <input type="text" class="form-control" id="edit-snippet-title" name="edit-snippet-title" value="' + editSnippetTitle + '" required="required" pattern="[a-zA-Z0-9_ -]{1,150}"> </div> </div><div class="form-group"><textarea name="edit-snippet-code" id="edit-snippet-code" rows="10">' + editSnippetCode + '</textarea></div><div class="form-group"> <div class="btn-group"> <button type="submit" class="btn btn-primary" id="edit-snippet-ok-button">OK</button> <button type="button" class="btn btn-default" id="edit-snippet-cancel-button">Cancel</button> </div> </div></form>');
