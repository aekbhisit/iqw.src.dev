...
$get_path = '/sites/'.$_SESSION['_DOMAIN_ID'].'/files/u/' ;  // parse_url($_GET['images_path']);


$img_dir = $get_path ; //$get_path['path']; // ex : '/dir/img/' with or without slashes
...
// $img_path = $_SERVER['DOCUMENT_ROOT'].'/sites/'.$_SESSION['_DOMAIN_ID'].'/files/u/' ;

// if (!is_dir($img_path) ){
//     $security_msg = '<body><div class="container"><p>&nbsp;</p><p class="alert alert-danger"> '.$img_path.' no dir Your images dir is not authorized.</p><p class="text-center">Please create an empty file named <i>secure.php</i> and save it into your images directory to allow access.</p></div><body>';
// }else{
//     $security_msg = '<body><div class="container"><p>&nbsp;</p><p class="alert alert-danger"> '.$img_path.' No dir Your images dir is not authorized.</p><p class="text-center">Please create an empty file named <i>secure.php</i> and save it into your images directory to allow access.</p></div><body>';
// }
