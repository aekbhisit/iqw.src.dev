                  ...
                  <!--search box-->
                   ...
                   <!-- Breadcrumbs -->
					...
					$breadcrumbs = array(
						...
						1=>array('name'=>'Layout','alt'=>'Categoies','link'=>'categories.php','class'=>''),
                                	...
                                	<form class="da-form" name="categories_form" id="categories_form" enctype="multipart/form-data" onsubmit="setSaveCategories();return false;">
                                    	...
                                    	<div class="da-form-inline">
                                         	 <div class="da-form-row">
                                                <label>Route หลัก<span class="required">*</span></label>
                                                <div class="da-form-item large">
                                                	<span class="formNote"  >เลือก Query หลัก (ถ้ามี)</span>
                                                    <select id="categories_parent" name="categories_parent" disabled="disabled" ></select>
                                                </div>
                                            </div>
                                            <div class="da-form-row">
                                                <label>ชื่อ Route <span class="required">*</span></label>
                                                <div class="da-form-item large">
                                                	<span class="formNote" >ใส่ชื่อ Query</span>
                                             ...
                                             <div class="da-form-row">
                                                ...
                                                <div class="da-form-item large">
                                                	<span class="formNote"  >ใส่ Slug Layout</span>
                                                    <input type="text" name="categories_slug" id="categories_slug" value="" />
                                                </div>
                                            </div>
                                            <div class="da-form-row">
                                                <label>ไฟล์ Layout</label>
                                                <div class="da-form-item large">
                                                	<span class="formNote"  >ใส่ไฟล์ Theme Layout (index.php)</span>
                                                      <input type="text" name="categories_layout" id="categories_layout" value="" />
                                                </div>
                                            </div>
                                            <div class="da-form-row"  id="findInCategoryContainer">
                                                <label>Data </label>
                                                <div class="da-form-item large">
                                                	<span class="formNote" >Query Data {$DATA}</span>
                                                    <button id="da-dialog-find-query" class="da-button blue">เลือก Query</button>
                                                        <div id="da-dialog-div-query" style="display:none;">
                                                        	   <div class="da-panel-content" id="da-ex-datatable-query-container">
                                                                    <table id="da-ex-datatable-query-cat" class="da-table">
                                                                        <thead>
                                                                            <tr>
                                                      ...
                                                      <div id="showFindQuerySelectedContainer" style="display:none;">
                                                      <p>
                                                     <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tbody id="findQuerySelected">
                                                       </tbody>
                                                        </table>
                                                        </div>
                                                </div>
                                      		...
                                      		<div class="da-form-row">
                                                ...
                                                <div class="da-form-item small">
                                                	<span class="formNote">เลือกสถานการใช้งาน Layout</span>
