            ...
            <div class="da-container clearfix">
             ...
             <!-- Sidebar -->
                ...
                <div id="da-content-wrap" class="clearfix">
                    ...
                    <div style="display:block; width:100%; min-height:35px; height:auto; clear:both; padding-left:10px; padding-right:10px;"><a href="categories-form.php?mode=add"><button class="da-button green medium">เพิ่ม Route ใหม่</button></a></div>
                    	...
                    	<div class="grid_4">
                         ...
                         <div style="display:block; width:100%; min-height:35px; height:auto; clear:both; padding-left:10px; padding-right:10px;"><button class="da-button red medium" onclick="setDeleteSelectedData();">ลบรายการที่เลือก</button></div>                       
                    </div>
                </div>
            </div> 
        </div>
