...
<?php
$modules = 'newsletters';
$modules_name = 'จดหมายข่าว';
$module_active = 'newsletters' ;
?>
            ...
            <div id="da-header-bottom">
                ...
                <div class="da-container clearfix">
					...
					$breadcrumbs = array(
						...
						1=>array('name'=>$modules_name,'alt'=>$modules_name,'link'=>'javascript:void(0)','class'=>'active')
					);
        ...
        <div id="da-content">
            ...
            <div class="da-container clearfix">
                ...
                <div id="da-content-wrap" class="clearfix">
                    ...
                    <div style="display:block; width:100%; min-height:35px; height:auto; clear:both; padding-left:10px; padding-right:10px;"><a href="../../app/index.php?module=newsletters&task=exportCSV" ><button class="da-button green medium">ส่งออกไฟล์ CSV</button></a></div>
