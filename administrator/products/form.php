...
<?php
$modules = 'products';
$modules_name = 'products';
$module_active = 'products';
?>
                        	...
                        	<div class="da-panel">
                                ...
                                <div id="form-error" class="da-message error" style="display:none;"></div>
                                    	<div class="da-form-inline">
                                            ...
                                            <div class="da-form-row">
                                                <label>ชื่อบล็อก <span class="required">*</span></label>
                                                <div class="da-form-item large">
                                                	<span class="formNote" >ใส่ชื่อสินค้า</span>
                                            ...
                                            <div class="da-form-row">
                                                ...
                                                <div class="da-form-item large">
                                                	<span class="formNote"  >ใส่รายละเอียดสินค้า</span>
                                            ...
                                            <div class="da-form-row">
                                                <label>ภาพ 1</label>
                                                <div class="da-form-item large">
                                                	<span class="formNote" >ใส่ภาพของสินค้า(ถ้ามี)</span>
                                                    <div id="finder"></div>
                                             ...
                                             <div class="da-form-row">
                                                ...
                                                <div class="da-form-item large">
                                                    <span class="formNote" >ใส่ภาพของสินค้า(ถ้ามี)</span>
                                                    <div id="finder"></div>
                                                     <input type="text" name="image1" id="image1" value="" class="elfinder-browse" />
                                                     <img src="" id="show_image1" style="display:none; max-width:150px; max-height:150px; padding:10px; margin-top:20px; border:#CCC 1px solid; border-radius: 5px;" />
                                                </div>
                                            </div>
                                             <div class="da-form-row">
                                                <label>ภาพ 3</label>
                                                <div class="da-form-item large">
                                                    <span class="formNote" >ใส่ภาพของสินค้า(ถ้ามี)</span>
                                                    <div id="finder"></div>
                                                     <input type="text" name="image2" id="image2" value="" class="elfinder-browse" />
                                                     <img src="" id="show_image2" style="display:none; max-width:150px; max-height:150px; padding:10px; margin-top:20px; border:#CCC 1px solid; border-radius: 5px;" />
                                                </div>
                                            </div>
                                             <div class="da-form-row">
                                                <label>ภาพ 4</label>
                                                <div class="da-form-item large">
                                                    <span class="formNote" >ใส่ภาพของสินค้า(ถ้ามี)</span>
                                                    <div id="finder"></div>
                                                     <input type="text" name="image3" id="image3" value="" class="elfinder-browse" />
                                                     <img src="" id="show_image3" style="display:none; max-width:150px; max-height:150px; padding:10px; margin-top:20px; border:#CCC 1px solid; border-radius: 5px;" />
                                                </div>
                                            </div>
                                             <div class="da-form-row">
                                                <label>ภาพ 5</label>
                                                <div class="da-form-item large">
                                                    <span class="formNote" >ใส่ภาพของสินค้า(ถ้ามี)</span>
                                                    <div id="finder"></div>
                                                     <input type="text" name="image4" id="image4" value="" class="elfinder-browse" />
                                                     <img src="" id="show_image4" style="display:none; max-width:150px; max-height:150px; padding:10px; margin-top:20px; border:#CCC 1px solid; border-radius: 5px;" />
                                                </div>
                                            </div>
