            ...
            <div id="da-header-bottom">
                ...
                <div class="da-container clearfix">
					...
					$breadcrumbs = array(
						...
						1=>array('name'=>'สถิติ','alt'=>'Statistic','link'=>'javascript:void(0)','class'=>'active')
					);
        ...
        <div id="da-content">
            ...
            <div class="da-container clearfix">
                ...
                <div id="da-content-wrap" class="clearfix">
                    ...
                    <!--<div style="display:block; width:100%; min-height:35px; height:auto; clear:both; padding-left:10px; padding-right:10px;"><a href="news-form.php?mode=add"><button class="da-button green medium">เพิ่มข่าวสารใหม่</button></a></div>-->
                        ...
                        <div style="display:block; width:100%; min-height:35px; height:auto; clear:both; padding-left:10px; padding-right:10px;"><button class="da-button red medium" onclick="setDeleteAllStatData();" style="float:right; margin-right:20px;">! ลบข้อมูลสถิติทั้งหมด</button> 
                        </div>                 
                    </div>
                </div>
            </div> 
