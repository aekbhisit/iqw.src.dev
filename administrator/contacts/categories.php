                ...
                <div class="da-container clearfix">
                   <!--search box-->
					...
					$breadcrumbs = array(
						...
						1=>array('name'=>'ติดต่อ','alt'=>'Categories','link'=>'categories.php','class'=>''),
						2=>array('name'=>'ข้อมูล','alt'=>'Contacts','link'=>'javascript:void(0)','class'=>'active')
					);
        ...
        <div id="da-content">
            ...
            <div class="da-container clearfix">
                ...
                <div id="da-content-wrap" class="clearfix">
                    ...
                    <div style="display:block; width:100%; min-height:35px; height:auto; clear:both; padding-left:10px; padding-right:10px;"><a href="categories-form.php?mode=add"><button class="da-button green medium">เพิ่มที่อยู่</button></a></div>
