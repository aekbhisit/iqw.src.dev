...
<?php
$modules = 'downloads';
$modules_name = 'downloads';
$module_active = 'downloads';
?>
...
<script type="text/javascript" src="categories-form-script-translate.js"></script>
            ...
            <div id="da-header-bottom">
                ...
                <div class="da-container clearfix">
                    ...
                    $breadcrumbs = array(
                        ...
                        2=>array('name'=>'แปลภาษาหมวดหมู่','alt'=>'Translate','link'=>'javascript:void(0)','class'=>'active')
                    );
                                        ...
                                        <div class="da-form-inline">
                                            <div class="da-form-row">
                                                ...
                                                <div class="da-form-item large">
                                                    ...
                                                    <select id="categories_language" name="categories_language" disabled="disabled" ></select>
                                                </div>
                                            </div>
                                            <div class="da-form-row">
                                            ...
                                            <div class="da-form-row">
                                                <label>คำอธิบายหมวดหมู่<span class="required"></span></label>
                                                <div class="da-form-item large">
