                                    	...
                                    	<div class="da-form-inline">
                                         	 <div class="da-form-row">
                                                ...
                                                <div class="da-form-item large">
                                                    ...
                                                    <select id="categories_system" name="categories_system"  ></select>
                                                </div>
                                            </div>
                                             
                                             <div class="da-form-row">
                                                <label>กลุ่มหลัก<span class="required">*</span></label>
                                                <div class="da-form-item large">
                                                	<span class="formNote"  >เลือกกลุ่มหลัก (ถ้ามี)</span>
                                            ...
                                            <div class="da-form-row">
                                                ...
                                                <div class="da-form-item large">
                                                	<span class="formNote" >ใส่ชื่อกลุ่ม</span>
                                             ...
                                             <div class="da-form-row">
                                                <label>Slug</label>
                                                <div class="da-form-item large">
                                                	<span class="formNote" >ใส่ slug กลุ่ม</span>
                                                    <input type="text" name="categories_slug" id="categories_slug" value="" />
                                                </div>
                                            </div>
                                            <div class="da-form-row">
                                                <label>คำอธิบายกลุ่มหลัก</label>
                                                <div class="da-form-item large">
                                                	<span class="formNote"  >ใส่คำอธิบายกลุ่มหลัก</span>
